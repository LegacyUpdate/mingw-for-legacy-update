...
sudo cp -v zlib.h zconf.h /opt/gcc-14.2-binutils-2.44-mingw-v12.0.0-i686/include
sudo cp -v libz.a libz.dll.a /opt/gcc-14.2-binutils-2.44-mingw-v12.0.0-i686/lib
sudo mkdir -pv /opt/gcc-14.2-binutils-2.44-mingw-v12.0.0-i686/lib/pkgconfig
sudo cp -v zlib.pc /opt/gcc-14.2-binutils-2.44-mingw-v12.0.0-i686/lib/pkgconfig
