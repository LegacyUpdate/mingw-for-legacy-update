...
scons VERSION=$VERSION                   \
      ...
      ZLIB_W32=/opt/gcc-14.2-binutils-2.44-mingw-v12.0.0-i686/lib &&
...
sudo scons VERSION=$VERSION                   \
           ...
           STRIP_CP=false                     \
           NSIS_MAX_STRLEN=8192               \
           ZLIB_W32=/opt/gcc-14.2-binutils-2.44-mingw-v12.0.0-i686/lib install
